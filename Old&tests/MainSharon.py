...
p1 = SPFoop.SPF('iai.co.il')
info1 = p1.SPFcheck('iai.co.il')
...
p1 = DMARCoop.DMARC('iai.co.il')
info1 = p1.DMARCcheck('iai.co.il')
...
p1 = MXoop.MX('iai.co.il')
info1 = p1.MXcheck('iai.co.il')
